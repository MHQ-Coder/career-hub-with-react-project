    ...
    return (
        <div className="">
            <footer className="">
                ...
                <footer className="text-center md:text-start p-10 bg-base-200 text-base-content bg-gradient-to-r from-indigo-200">
                    <div className=" md:footer md:max-w-6xl md:mx-auto gap-6">
                        <nav className="">
                ...
                <footer className="  bg-gradient-to-r from-indigo-200 footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                    <div className="flex justify-center md:flex-row md:justify-start footer max-w-6xl mx-auto">
